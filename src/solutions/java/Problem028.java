...
public class Problem028 {
     ...
     * For the nth layer of numbers around the center, the following closed-form expressions for the corners can be derived for n >= 2:
     * 4n^2 - 4n + 1, 4n^2 - 6n + 3, 4n^2 - 8n + 5, 4n^2 - 10n + 7
     * Therefore, the sum of the corners in the nth layer is 16n^2 - 28n + 16.
